...
export function shapeOf(meta: MetricMeta): ValueShape {
  return {
    unit: meta.unit,
...
export function formatValue(value: number, shape: ValueShape): string {
 ...
 */
export function formatBare(value: number, shape: ValueShape): string {
...
export function unitSuffix(shape: ValueShape): string {
...
export function directionOf(change: number | null, epsilon = 0.05): Direction {
...
export function formatChange(change: number | null, precision = 1): string {
